$(document).ready(function(){
    $("#rate").text("RATE THIS BOOK");
    $("#book1, #wallpa i").hover(function(){$("#information").show();
    $("#wallpa").show();
    $("#wallpa2,#wallpa3, #wallpa4, #wallpa5, #wallpa6, #wallpa7, #wallpa8").hide();
    $("#information").css({"top":"0%"});
    $("#information").css({"left":"19.5%"});
    $("#booktitle").text("YOU DON'T KNOW JS");
    $("#bookdate").text("YOU DON'T KNOW JS");
    $("#booknovel").text("YOU DON'T KNOW JS");
    $("#bookauthor").text("YOU DON'T KNOW JS");
    $("#bookpages").text("YOU DON'T KNOW JS");
    $("#booksummary").text("YOU DON'T KNOW JS");
    $("#bookdescrip").text("YOU DON'T KNOW JS");
    $("#bookrating").text("YOU DON'T KNOW JS");
    $("#bookrecommended").text("YOU DON'T KNOW JS");
    ...
    $("*").click(function(){
       $("#information").hide();
       $("#wallpa, #wallpa2, #wallpa3, #wallpa4, #wallpa5, #wallpa6, #wallpa7, #wallpa8").hide();
    ...
    $("#booktitle").text("DON QUIJOTE DE LA MANCHA");
    $("#bookdate").text("YOU DON'T KNOW JS");
    $("#booknovel").text("YOU DON'T KNOW JS");
    $("#bookauthor").text("YOU DON'T KNOW JS");
    $("#bookpages").text("YOU DON'T KNOW JS");
    ...
    $("#information").css({"top":"0%"});
    $("#booktitle").text("ROMEO AND JULIET");
    $("#bookdate").text("YOU DON'T KNOW JS");
    $("#booknovel").text("YOU DON'T KNOW JS");
    $("#bookauthor").text("YOU DON'T KNOW JS");
    $("#bookpages").text("YOU DON'T KNOW JS");
    ...
    $("#booktitle").text("BIG LITTLE LIES");
    $("#bookdate").text("YOU DON'T KNOW JS");
    $("#booknovel").text("YOU DON'T KNOW JS");
    $("#bookauthor").text("YOU DON'T KNOW JS");
    $("#bookpages").text("YOU DON'T KNOW JS");
    ...
    $("#information").css({"top":"43%"});
    $("#information").css({"left":"12.5%"});
    $("#booktitle").text("THUS SPOKE ZARATHUSTRA");
    $("#bookdate").text("YOU DON'T KNOW JS");
    $("#booknovel").text("YOU DON'T KNOW JS");
    $("#bookauthor").text("YOU DON'T KNOW JS");
    $("#bookpages").text("YOU DON'T KNOW JS");
